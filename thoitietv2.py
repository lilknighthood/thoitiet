...
import psutil  # Thư viện để giám sát tài nguyên
...
def show_toast(message):
    """Hiển thị thông báo bằng termux-toast."""
    try:
...
def usage():
    return """
thoitietv2 0.0.2 (c) 2023 rofl0r, drygdryg modded by vladimir127001, enhanced by Grok
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='thoitietv2 0.0.2 (c) 2023 rofl0r, drygdryg modded by vladimir127001, enhanced by Grok',
